...
import com.learning.core.bean.RequestDetail;
import com.learning.core.enums.ApiCode;
import com.learning.core.exception.SpringBootException;
import com.learning.exception.exception.*;
import com.learning.core.bean.RequestDetailThreadLocal;
import com.learning.shiro.exception.JWTDecodeException;
import com.learning.shiro.exception.NotLoginException;
import com.learning.shiro.exception.SysLoginException;
import com.learning.shiro.exception.UnauthorizedException;
...
public class GlobalExceptionHandler {
    ...
    @ResponseStatus(HttpStatus.OK)
    public ApiResult<String> AccountException(AccountException exception) {
    ...
    @ResponseStatus(HttpStatus.OK)
    public ApiResult<Boolean> unauthorizedExceptionHandler(AuthenticationException exception) {
        this.printRequestDetail();
        ...
        this.printApiCodeException(ApiCode.USER_ONTEXIST_ROLEINFO, exception);
        return ApiResult.fail(ApiCode.USER_ONTEXIST_ROLEINFO);
