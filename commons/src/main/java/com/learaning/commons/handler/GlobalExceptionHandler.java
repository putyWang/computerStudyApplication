...
import com.learaning.commons.bean.RequestDetail;
import com.learaning.commons.entity.ApiResult;
import com.learaning.commons.enums.ApiCode;
import com.learaning.commons.exception.*;
import com.learaning.commons.utils.RequestDetailThreadLocal;
...
public class GlobalExceptionHandler {
    ...
    @ResponseStatus(HttpStatus.OK)
    public ApiResult<String> notPermissionExceptionHandler(NotPermissionException exception) {
        printRequestDetail();
        printApiCodeException(ApiCode.NOT_PERMISSION, exception);
        String message = "无此权限：" + exception.getCode();
